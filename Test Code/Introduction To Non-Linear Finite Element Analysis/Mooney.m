...
%   The second Piola-Kirchhoff stress and material stiffness for a
%   Mooney-Rivlin material

%   Inputs
%   F           = Deformation gradient [3x3]
%   A10, A01, K = Material constants
%   ltan        = 0 -> Calculate only the stress
%               = 1 -> Calculate the stress and material stiffness

%   Outputs
%   Stress      = The second Piola-Kirchhoff stress [S11, S22, S33, S12,
%                 S23, S13]
