...
\begin{figure}[H]
	...
	\caption{Soft robot constructed from a tetrahedral mesh \citep{Rieffel2013}}
	\label{fig:mesh}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Soft body represented by a Gaussian density mixture \citep{Hiller2012}}
	\label{fig:gauss}
\end{figure}
