...
from evolve_soft_2d.file_paths import fp_bm, fp_m
from evolve_soft_2d.log_settings import m_log
...
def open_model(s, e, f):

    if f == "bm":
        fp_o = fp_bm + r'\grid_' + s + r'\grid_' + s + '.mud'

    elif f == "m":
        fp_o = fp_m + r'\grid_' + e + r'\grid_' + s + r'\grid_' + s + '.mud'
...
def save_model(s, e, f):

    if f == "bm":
        utility.make_folder(fp_bm + r'\grid_' + s)
        fp_s = fp_bm + r'\grid_' + s + r'\grid_' + s + '.mud'

    elif f == "m":
        utility.make_folder(fp_m + r'\grid_' + e + r'\grid_' + s)
        fp_s = fp_m + r'\grid_' + e + r'\grid_' + s + r'\grid_' + s + '.mud'
